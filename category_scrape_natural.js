...
const getLinks = async (driver) => {
    ...
    //remove animals
    //missing Mammals, Birds, non avian, reptiles, fish, antropods, other invert, animals domestic
    ...
    subsubNames.splice(15, 0, "Viruses");
    subsubNames.splice(
        20,
        1,
    ...
    console.log(subsubNames);
    console.log("subcat length", subsubNames.length);
    let subsubIndex = 0;
    ...
    for (const paragraphNodes of subsubNodes) {
        ...
        for (const paragraphNode of paragraphNodes) {
            ...
            result[subsubNames[subsubIndex]] = anchors;

            subsubIndex++;
        }
    }

    console.log("paraCount", paragraphCount);
